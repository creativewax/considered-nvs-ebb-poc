...
// ------------------------------------------------------------ ORB PRESETS
// Rich material colours provide base hue (deep, not neon).
// Subtle coloured lights add gradient.
// Env map at 0.6 adds reflective depth.
...
const ORB_PRESETS = {
  ...
  very_good: {
    ...
    roughness: 0.1, metalness: 0.35, clearcoat: 0.4, clearcoatRoughness: 0.15,
    envMapIntensity: 1.3, transmission: 0.1,
  ...
  good: {
    ...
    roughness: 0.12, metalness: 0.35, clearcoat: 0.3, clearcoatRoughness: 0.2,
  ...
  moderate: {
    ...
    roughness: 0.15, metalness: 0.45, clearcoat: 0.2, clearcoatRoughness: 0.2,
  ...
  fair: {
    ...
    roughness: 0.18, metalness: 0.45, clearcoat: 0.2, clearcoatRoughness: 0.3,
    envMapIntensity: 1.0, transmission: 0,
  ...
  poor: {
    ...
    roughness: 0.2, metalness: 0.55, clearcoat: 0.1, clearcoatRoughness: 0.1,
    envMapIntensity: 0.8, transmission: 0,
  ...
  very_poor: {
    ...
    roughness: 0.25, metalness: 0.55, clearcoat: 0.1, clearcoatRoughness: 0.1,
  ...
  disrupted: {
    ...
    roughness: 0.3, metalness: 0.55, clearcoat: 0.1, clearcoatRoughness: 0.1,
    envMapIntensity: 0.7, transmission: 0,
