...
// ------------------------------------------------------------ ORB PRESETS
// VIVID material colour = base hue (bright, saturated)
// Coloured lights = gradient accent tinting
// Env map = sharp reflections
// ACES tone mapping = rich cinematic look
...
const ORB_PRESETS = {
  ...
  excellent: {
    ...
    roughness: 0.05, metalness: 0.3, clearcoat: 0.6, clearcoatRoughness: 0.1,
    envMapIntensity: 1.5, transmission: 0.3, ior: 1.8,
    color: '#5DE8C0', lightKey: '#88DDC0', lightFill: '#44AEC6', lightRim: '#E8DCC8',
  ...
  very_good: {
    ...
    roughness: 0.1, metalness: 0.4, clearcoat: 0.4, clearcoatRoughness: 0.15,
    envMapIntensity: 1.2, transmission: 0.1,
    color: '#2FC87A', lightKey: '#3DAA7A', lightFill: '#88DDC0', lightRim: '#44AEC6',
  ...
  good: {
    ...
    roughness: 0.12, metalness: 0.4, clearcoat: 0.3, clearcoatRoughness: 0.2,
    envMapIntensity: 1.2, transmission: 0,
    color: '#38B8D8', lightKey: '#44AEC6', lightFill: '#3DAA7A', lightRim: '#7BAFAA',
  ...
  moderate: {
    ...
    roughness: 0.15, metalness: 0.5, clearcoat: 0.2, clearcoatRoughness: 0.2,
    envMapIntensity: 1.0, transmission: 0,
    color: '#6BC8B8', lightKey: '#7BAFAA', lightFill: '#D4A84B', lightRim: '#44AEC6',
  ...
  fair: {
    ...
    roughness: 0.18, metalness: 0.5, clearcoat: 0.2, clearcoatRoughness: 0.3,
    envMapIntensity: 1.0, transmission: 0,
    color: '#E8B840', lightKey: '#D4A84B', lightFill: '#E8834A', lightRim: '#7BAFAA',
  ...
  restless: {
    ...
    roughness: 0.2, metalness: 0.5, clearcoat: 0.15, clearcoatRoughness: 0.3,
    envMapIntensity: 0.8, transmission: 0,
    color: '#F08040', lightKey: '#E8834A', lightFill: '#D4A84B', lightRim: '#D0566C',
  ...
  poor: {
    ...
    roughness: 0.2, metalness: 0.6, clearcoat: 0.1, clearcoatRoughness: 0.1,
    envMapIntensity: 0.8, transmission: 0,
    color: '#E04060', lightKey: '#D0566C', lightFill: '#E8834A', lightRim: '#6B3FA0',
  ...
  very_poor: {
    ...
    roughness: 0.25, metalness: 0.6, clearcoat: 0.1, clearcoatRoughness: 0.1,
    envMapIntensity: 0.7, transmission: 0,
    color: '#C02858', lightKey: '#8B2252', lightFill: '#D0566C', lightRim: '#6B3FA0',
  ...
  disrupted: {
    ...
    roughness: 0.3, metalness: 0.6, clearcoat: 0.1, clearcoatRoughness: 0.1,
    envMapIntensity: 0.7, transmission: 0,
    color: '#9030A0', lightKey: '#D0566C', lightFill: '#6B3FA0', lightRim: '#8B2252',
